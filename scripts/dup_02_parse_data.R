...
# filenames
# fixed mu sims
mu1_n1 <- 'fixed_mu1_n_100_sims_all.txt'
mu1_n2 <- 'fixed_mu1_n_316_sims_all.txt'
mu1_n3 <- 'fixed_mu1_n_1000_sims_all.txt'
mu1_n4 <- 'fixed_mu1_n_3160_sims_all.txt'
mu1_n5 <- 'fixed_mu1_n_10000_sims_all.txt'
mu1_n6 <- 'fixed_mu1_n_31600_sims_all.txt'

mu2_n1 <- 'fixed_mu2_n_100_sims_all.txt'
mu2_n2 <- 'fixed_mu2_n_316_sims_all.txt'
mu2_n3 <- 'fixed_mu2_n_1000_sims_all.txt'
mu2_n4 <- 'fixed_mu2_n_3160_sims_all.txt'
mu2_n5 <- 'fixed_mu2_n_10000_sims_all.txt'
mu2_n6 <- 'fixed_mu2_n_31600_sims_all.txt'

mu3_n1 <- 'fixed_mu3_n_100_sims_all.txt'
mu3_n2 <- 'fixed_mu3_n_316_sims_all.txt'
mu3_n3 <- 'fixed_mu3_n_1000_sims_all.txt'
mu3_n4 <- 'fixed_mu3_n_3160_sims_all.txt'
mu3_n5 <- 'fixed_mu3_n_10000_sims_all.txt'
mu3_n6 <- 'fixed_mu3_n_31600_sims_all.txt'

# fixed n sims
n1_mu1 <- 'fixed_n1_mu1_sims_all.txt'
n1_mu2 <- 'fixed_n1_mu2_sims_all.txt'
n1_mu3 <- 'fixed_n1_mu3_sims_all.txt'
n1_mu4 <- 'fixed_n1_mu4_sims_all.txt'
n1_mu5 <- 'fixed_n1_mu5_sims_all.txt'
n1_mu6 <- 'fixed_n1_mu6_sims_all.txt'

n2_mu1 <- 'fixed_n2_mu1_sims_all.txt'
n2_mu2 <- 'fixed_n2_mu2_sims_all.txt'
n2_mu3 <- 'fixed_n2_mu3_sims_all.txt'
n2_mu4 <- 'fixed_n2_mu4_sims_all.txt'
n2_mu5 <- 'fixed_n2_mu5_sims_all.txt'
n2_mu6 <- 'fixed_n2_mu6_sims_all.txt'

n3_mu1 <- 'fixed_n3_mu1_sims_all.txt'
n3_mu2 <- 'fixed_n3_mu2_sims_all.txt'
n3_mu3 <- 'fixed_n3_mu3_sims_all.txt'
n3_mu4 <- 'fixed_n3_mu4_sims_all.txt'
n3_mu5 <- 'fixed_n3_mu5_sims_all.txt'
n3_mu6 <- 'fixed_n3_mu6_sims_all.txt'
...
pop_mu1_n1 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n1))
pop_mu1_n2 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n2))
pop_mu1_n3 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n3))
pop_mu1_n4 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n4))
pop_mu1_n5 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n5))
pop_mu1_n6 <- readLines(file.path(path_to_raw, 'fixed_mu', mu1_n6))

pop_mu2_n1 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n1))
pop_mu2_n2 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n2))
pop_mu2_n3 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n3))
pop_mu2_n4 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n4))
pop_mu2_n5 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n5))
pop_mu2_n6 <- readLines(file.path(path_to_raw, 'fixed_mu', mu2_n6))

pop_mu3_n1 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n1))
pop_mu3_n2 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n2))
pop_mu3_n3 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n3))
pop_mu3_n4 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n4))
pop_mu3_n5 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n5))
pop_mu3_n6 <- readLines(file.path(path_to_raw, 'fixed_mu', mu3_n6))

# read in data for set: fixed n
pop_n1_mu1 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu1))
pop_n1_mu2 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu2))
pop_n1_mu3 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu3))
pop_n1_mu4 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu4))
pop_n1_mu5 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu5))
pop_n1_mu6 <- readLines(file.path(path_to_raw, 'fixed_n', n1_mu6))

pop_n2_mu1 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu1))
pop_n2_mu2 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu2))
pop_n2_mu3 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu3))
pop_n2_mu4 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu4))
pop_n2_mu5 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu5))
pop_n2_mu6 <- readLines(file.path(path_to_raw, 'fixed_n', n2_mu6))

pop_n3_mu1 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu1))
pop_n3_mu2 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu2))
pop_n3_mu3 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu3))
pop_n3_mu4 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu4))
pop_n3_mu5 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu5))
pop_n3_mu6 <- readLines(file.path(path_to_raw, 'fixed_n', n3_mu6))
