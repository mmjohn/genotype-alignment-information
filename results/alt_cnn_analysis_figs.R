...
# Comparisons of alterred CNN performance when duplicates are included; using 
# simulation sets with a high and low amount of duplicates
# This script: creates figures for alt CNN performance comparison
# Mackenzie M. Johnson
# April 2022 
...
test_losses_high <- test_losses_all
rm(test_losses_all)
...
dup_training %>%
  ...
  theme_half_open() +
  background_grid() -> fig_alt_dup_training

fig_alt_dup_training
...
save_plot(
  ...
  fig_alt_dup_training, ncol = 1, nrow = 1, base_height = 4.71,
  base_asp = 1.618, base_width = NULL
)


save_plot(
  file.path(path_to_results, 'figures', 'fig_alt_low_v_high_dup_performance.png'),
  fig_alt_low_v_high, ncol = 1, nrow = 1, base_height = 4.71,
  base_asp = 1.618, base_width = NULL
)

save_plot(
  file.path(path_to_results, 'figures', 'fig_alt_low_v_high_dup_perform_trans.png'),
  fig_alt_low_v_high_trans, ncol = 1, nrow = 1, base_height = 4.71,
  base_asp = 1.618, base_width = NULL
)
